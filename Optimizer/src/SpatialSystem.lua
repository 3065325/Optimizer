--[=[
    ...
    local function hasContents(tab) for _, _ in pairs(tab) do return true end return false end
    ...
    -- Cleanup
    function SpatialSystem:_cleanCell(cellPosition)
        if hasContents(self.cells[cellPosition]) then return end
        self.cells[cellPosition] = nil
    end
    ...
    function SpatialSystem:SetObjectPosition(object)
        self._cells[self._objects[object]][object] = nil
    end
]=]
